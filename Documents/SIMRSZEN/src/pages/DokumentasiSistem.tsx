    ...
    // Slide 1: Cover
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full text-white text-center px-8">
          ...
          >
            <p className="font-semibold">SIMRS ZEN</p>
            <p className="text-sm">Solusi Digital Rumah Sakit Indonesia</p>
          </motion.div>
        </div>
      )
    },
        ...
        <div className="p-8 md:p-12 text-white h-full flex flex-col justify-center">
          ...
          <div className="max-w-2xl mx-auto w-full">
            ...
            <div className="text-center text-slate-400">
              ...
              <p className="mt-4 text-sm">© 2026 SIMRS ZEN. All rights reserved.</p>
            </div>
          </div>
        </div>
      )
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full text-white text-center px-8">
          ...
          >
            ...
            <p className="text-teal-200 mt-2">info@simrszen.id | +62 851-2104-5798</p>
          </motion.div>
        </div>
      )
    }
