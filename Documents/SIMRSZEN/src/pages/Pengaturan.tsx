...
import { HospitalLogoUpload } from "@/components/profile/HospitalLogoUpload";
import BsreSignatureSettings from '@/components/settings/BsreSignatureSettings';
    ...
    <div className="p-6 space-y-6">
      ...
      <Tabs defaultValue="hospital" className="space-y-4">
        <TabsList className="flex-wrap h-auto gap-1">
          ...
          <TabsTrigger value="esign" className="gap-1">
        ...
        <TabsContent value="esign">
          {hospitalId ? (
            <BsreSignatureSettings hospitalId={hospitalId} />
          ) : (
            <Card>
              <CardHeader>
                <CardTitle>Loading...</CardTitle>
                <CardDescription>
                  Memuat pengaturan tanda tangan elektronik
                </CardDescription>
              </CardHeader>
            </Card>
          )}
      ...
      {/* Update the tabs list to include e-signature */}
      <div className="p-6 space-y-6">
        {/* Header */}
        <div className="flex items-center justify-between">
          <div>
