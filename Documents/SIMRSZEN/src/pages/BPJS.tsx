...
export default function BPJS() {
  ...
  // Mock BPJS claim data - replace with real API integration when BPJS bridge is configured
  const mockClaims: BPJSClaim[] = [
    { id: '1', claim_number: 'KLM-2604-001', sep_number: 'SEP-2604-001', patient_id: 'p1', visit_id: 'v1', claim_date: '2026-04-20', claim_amount: 4850000, approved_amount: 4850000, status: 'approved', inacbg_code: 'O-1-14-I', inacbg_description: 'Normal delivery', rejection_reason: null, submission_date: '2026-04-21', verification_date: '2026-04-23', notes: null, patients: { full_name: 'Anisa Wulandari', medical_record_number: 'RM-001234', bpjs_number: '0001234567890' } },
    { id: '2', claim_number: 'KLM-2604-002', sep_number: 'SEP-2604-002', patient_id: 'p2', visit_id: 'v2', claim_date: '2026-04-21', claim_amount: 1250000, approved_amount: null, status: 'submitted', inacbg_code: 'J-4-19-I', inacbg_description: 'Hypertension', rejection_reason: null, submission_date: '2026-04-22', verification_date: null, notes: null, patients: { full_name: 'Budi Santoso', medical_record_number: 'RM-001235', bpjs_number: '0001234567891' } },
    { id: '3', claim_number: 'KLM-2604-003', sep_number: 'SEP-2604-003', patient_id: 'p3', visit_id: 'v3', claim_date: '2026-04-22', claim_amount: 6320000, approved_amount: null, status: 'rejected', inacbg_code: 'E-4-14-I', inacbg_description: 'Pneumonia NOS', rejection_reason: 'Kode diagnosis tidak sesuai dengan prosedur yang dilakukan', submission_date: '2026-04-22', verification_date: '2026-04-24', notes: null, patients: { full_name: 'Citra Lestari', medical_record_number: 'RM-001236', bpjs_number: '0001234567892' } },
    { id: '4', claim_number: 'KLM-2604-004', sep_number: 'SEP-2604-004', patient_id: 'p4', visit_id: 'v4', claim_date: '2026-04-23', claim_amount: 7200000, approved_amount: 7200000, status: 'paid', inacbg_code: 'G-4-14-I', inacbg_description: 'Appendectomy', rejection_reason: null, submission_date: '2026-04-23', verification_date: '2026-04-25', notes: null, patients: { full_name: 'Deni Kusuma', medical_record_number: 'RM-001237', bpjs_number: '0001234567893' } },
    { id: '5', claim_number: 'KLM-2604-005', sep_number: 'SEP-2604-005', patient_id: 'p5', visit_id: 'v5', claim_date: '2026-04-24', claim_amount: 8500000, approved_amount: null, status: 'draft', inacbg_code: null, inacbg_description: null, rejection_reason: null, submission_date: null, verification_date: null, notes: 'Persalinan SC elektif', patients: { full_name: 'Eka Putri', medical_record_number: 'RM-001238', bpjs_number: '0001234567894' } },
  ];

  const { data: claims = mockClaims, isLoading } = useQuery({
    queryKey: ["bpjs-claims", statusFilter],
    queryFn: async () => {
      // Return mock data - integrate with real BPJS API when credentials are configured
      return mockClaims.filter(c => statusFilter === 'all' || c.status === statusFilter);
    },
  });
  ...
  const updateStatus = useMutation({
    mutationFn: async ({ claimId, status }: { claimId: string; status: ClaimStatus }) => {
      try {
        ...
        // Mock success without actual DB call since we're using mock data
