  ...
  const { data: billings = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      let query = `
        ...
        GROUP BY b.id, b.invoice_number, b.patient_id, b.visit_id, 
                 b.billing_date, b.payment_type, b.subtotal, b.discount,
                 b.tax, b.total, b.paid_amount, b.status, b.payment_method,
                 b.payment_date, b.notes, p.full_name, p.medical_record_number
      ...
      const data = await getApi<any[]>` ${query} `;
